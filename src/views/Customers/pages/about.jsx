          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8">
                ...
                <img src="customer/images/about/sign.png" alt="" className="img-fluid"/>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section team">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-6">
                <div className="section-title text-center">
                  ...
                  <p>Today’s users expect effortless experiences. Don’t let essential people and processes stay stuck in
                    the past. Speed it up, skip the hassles</p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="team-block mb-5 mb-lg-0">
                  <img src="customer/images/team/2.jpg" alt="" className="img-fluid w-100"/>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="team-block mb-5 mb-lg-0">
                  <img src="customer/images/team/3.jpg" alt="" className="img-fluid w-100"/>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="team-block">
                  <img src="customer/images/team/4.jpg" alt="" className="img-fluid w-100"/>
