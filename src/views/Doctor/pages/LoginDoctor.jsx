...
import { GetUserDoctor } from '../../../state/Auth/authDoctorSlice';

const LoginDoctor = () => {
    const navigate = useNavigate();
    const userDoctor = useSelector(GetUserDoctor)
    ...
    const onClickLogin = async (e) => {
        ...
        try {
            ...
            if (response.data.status === "success") {
                localStorage.setItem("jwtDoctor", response.data.token);
                                ...
                                <div class="col-lg-5 col-md-5 col-12" style={{ marginTop: '10.5%' }}>
                                    <div class="bg-white rounded10 shadow-lg">
                                        <div class="content-top-agile p-20 pb-0">
                                            ...
                                            <p class="mb-0">Sign in to continue to Manage Doctor.</p>
                                        </div>
                                        <div class="p-40">
                                            <form action="" method="">
